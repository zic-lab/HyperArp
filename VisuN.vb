Public Class VisuN
    ...
    Private Sub Debug_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        'Dim Numérateur As Integer = Form1.Det_Numérateur(Me.Métrique)
        ...
        Me.Size = p
        '
        DbgGrid.Rows = nb_PistesVar + 1 'Arrangement1.Nb_PistesMidi + 2
        DbgGrid.Cols = nbMesures * 16 ' < -- à remplacer par divisionmes Arrangement1.nbMesures * 16
        '
    ...
    Sub Dbg_AffPar(par As String)
        ...
        For pst = 0 To nb_PistesVar - 1 'Arrangement1.Nb_PistesMidi '
            For k = 0 To LesPistes(pst).DbgTabNotes.Count - 1
                If LesPistes(pst).DbgTabNotes.Count <> 0 Then ' par précaution - à laisser
    ...
    Private Sub DbgGrid_Load_1(sender As Object, e As EventArgs) Handles DbgGrid.Load
